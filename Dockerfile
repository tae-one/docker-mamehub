...
RUN apt-get update && \
    apt-get install -y unzip zip python-software-properties xvfb x11vnc openjdk-7-jre wget zip unzip libsdl1.2-dev libfontconfig1-dev libgconf2-dev libgtk2.0-dev libsdl-ttf2.0-dev yasm libqt4-dev aria2 libswt-* && \
    apt-get clean
